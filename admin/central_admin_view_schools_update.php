...
<body>
    ...
    <main>
        <form action="update_central_admin_profile.php" method="post">
            <p>
                <label for="new_first_name">School Name:</label>
    ...
    if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
        ...
        $query="UPDATE School SET School_Name='$fname', Last_Name='$lname', Email='$email', Phone_number='$pnum', School_Name='$sname' where Username='$username' ";
