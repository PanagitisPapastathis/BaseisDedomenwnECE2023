            ...
            <div class="col-md-12">
                ...
                <div class="card" id="card-container">
                    <div class="card-body" id="card">
                        ...
                        $isbn = $_POST['isbn'];
                        $query = "UPDATE Reviews SET Status = 'Accepted' WHERE Username = '$username' AND ISBN = '$isbn'";
                    ...
                    <div class="card-body" id="card">
                        <a class="btn btn-primary" id="show-btn" href="./admin_reviews.php">
                            <button type="button">Back</button>
                        </a>
                    </div>
                </div>
