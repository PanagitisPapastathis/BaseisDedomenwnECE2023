            ...
            >
                ...
                <div class="card" id="card-container">
                    <div class="card-body" id="card">
                        ...
                        $query = "SELECT * FROM Booking_Help where School_Name = '$school_name' order by Making_date"; 
                                ...
                                echo '<table class="table">';
                                    ...
                                    while($row = mysqli_fetch_row($result)){
                                        echo '<tr>';
                                            ...
                                            echo '<td>' . $row[5] . '</td>';
                                            echo '<td>';
                                                echo '<a type="button" href="./update_booking.php?copyid=' . $row[6]. '&username=' . $row[0] . '">';
