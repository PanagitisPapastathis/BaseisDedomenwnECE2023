            ...
            <div class="col-md-12">
                ...
                <div class="card" id="card-container">
                    <div class="card-body" id="card">
                        ...
                        $query = "SELECT * FROM Accept_Reviews_Help WHERE Status='Accepted' and School_Name = '$school_name'"; 
                        $result = mysqli_query($conn, $query);
                        
                        if(mysqli_num_rows($result) == 0){
                            echo '<p>No reviews made by students in you school have been accepted.</p>';
                        }
                        else{
