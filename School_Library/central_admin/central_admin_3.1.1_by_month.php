            ...
            <div class="col-md-12">
                <div class="card" id="card-container">
                    <div class="card-body" id="card">
                        ...
                        $conn = OpenCon(); 
                        session_start();
                        $query = "SELECT u.School_Name sn, monthname(l.Making_date) m, count(*) sum from Lending l inner join Users u where l.Username=u.Username group by u.School_Name, m";
