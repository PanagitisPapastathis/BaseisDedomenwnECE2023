...
<body>
    <nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
        <div id="navbar-div" class="container-fluid">
            <a class="navbar-brand" id="nav-bar-text">School Library - Books by Subject</a>
                ...
                <div class="card" id="card-container">
                    <div class="card-body" id="card">
                        <?php
                            ...
                            $query = "SELECT * from SubjectISBNTitleSchoolView v
                            JOIN Users u ON v.school_name = u.school_name
                            WHERE u.username = 'mwilmore7';";
