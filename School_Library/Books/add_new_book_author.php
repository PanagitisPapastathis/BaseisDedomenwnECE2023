                ...
                echo '<table class="table">';
                    ...
                    while($row = mysqli_fetch_row($result)){
                        echo '<tr>';
                            echo '<td>' . $row[0] . '</td>';
                            echo '<td>';
                                echo '<a type="button" href="./add_new_book_author_select.php?isbn='.$isbn.'&name='.$row[0].'">';
                    ...
                    echo '<tr>';
                            echo '<td>Other</td>';
                            echo '<td>';
                                echo '<a type="button" href="./add_new_book_author_select_other.php?isbn='.$isbn.'">';
                                    echo '<i class="fa fa-check"></i>';
                                echo '</a>';
                            echo '</td>';
                        echo '</tr>';
                    echo '</tbody>';
                echo '</table>';
                echo '<a href="./add_new_book_subject.php?isbn='.$isbn.'">';
                echo '<button type="button">Add Subject</button>';
                echo '</a>';
            echo '</div>';
        }
        ?>
