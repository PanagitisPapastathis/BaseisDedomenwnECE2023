...
<body>
    <nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
        <div id="navbar-div" class="container-fluid">
            <a class="navbar-brand" id="nav-bar-text">School Library - Change Author</a>
                                    ...
                                    echo '<table class="table">';
                                        ...
                                        while($row = mysqli_fetch_row($result)){
                                            echo '<tr>';
                                                echo '<td>' . $row[2] . '</td>';
                                                echo '<td>';
                                                echo '<form method="POST" action="./change_remove_book_authors.php?isbn=' . $row[1] .'">';
    ...
    <a href=<?php echo '"./books_edit.php?isbn='.$isbn.'"';?>>
