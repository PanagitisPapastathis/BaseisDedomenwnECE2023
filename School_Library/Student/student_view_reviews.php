...
<body>
    <nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
        <div id="navbar-div" class="container-fluid">
            <a class="navbar-brand" id="nav-bar-text">School Library- School Unit Student Page</a>
            ...
            <div class="col-md-12">
                ...
                <div class="card" id="card-container-layout">
                    <div class="card-body" id="card">
                        <h2 class="card-title">Access review</h2>
                    </div>
                </div>
                <div class="card" id="card-container">
                    ...
                    <div class="card" id="card-container-layout">
                    <div class="card-body" id="card">
                        <a class="btn btn-primary" id="show-btn" href="./student_reviews.php"><button type="button">Back</button></a>
                    </div>
                </div>
                </div>
