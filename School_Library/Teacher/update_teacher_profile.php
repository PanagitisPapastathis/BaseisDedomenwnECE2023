...
<head>
    ...
    <title>
        School Unit Teacher Profile Update
    </title>
...
<body>
    <nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
        <div id="navbar-div" class="container-fluid">
            <a class="navbar-brand" id="nav-bar-text">School Library - School Unit Teacher Update</a>
    ...
    <main>
        <form action="update_teacher_profile.php" method="post">
            <p>
