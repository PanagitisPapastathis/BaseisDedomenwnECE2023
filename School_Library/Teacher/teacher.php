...
<body>
    <nav class="navbar navbar-light navbar-expand-md" id="nav-bar">
        <div id="navbar-div" class="container-fluid">
            <a class="navbar-brand" id="nav-bar-text">School Library - Teacher page</a>
            ...
            <div class="col-md-4">
                <div class="card" id="card-container-layout">
                    <div class="card-body" id="card">
                        <h4 class="card-title">View Teacher_profile</h4>
                        <p class="card-text" id="paragraph">Personal Information</p>
                        <a class="btn btn-primary" id="show-btn" href="./Teacher_profile.php">Show</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="col-md-4">
                <div class="card" id="card-container-layout">
                    <div class="card-body" id="card">
                        ...
                        <a class="btn btn-primary" id="show-btn" href="./teacher_reviews.php">Show</a>
                    </div>
                </div>
            </div>
        </div>
