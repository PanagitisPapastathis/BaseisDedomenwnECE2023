...
<head>
    ...
    <body>
        ...
        $query="insert into Users (Username, Password, First_Name, Last_Name, Birth_Date, Status, Phone_number, Email, School_Name) values ('$username', '$pass', '$fname', '$lname', '$bdate', '$status', '$phone', '$email', '$sname')";
    ...
    if(mysqli_query($conn, $query)){
        if($status=="teacher"){
            ...
            header("Location:./central_admin.php");//εδώ να μπει το link για τη σελιδα του student
            exit();
        }
        else if($status="student"){
            //echo '<h2>Successful Sign up as student!</h2>';
            header("Location:./central_admin.php");//εδώ να μπει το link για τη σελιδα του teacher
            exit();
        }
